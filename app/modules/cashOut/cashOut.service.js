...
const insertIntoDB = async (data) => {
  ...
  const result = await CashOut.create(data);
...
const getAllFromDB = async () => {
    ...
    const result = await CashOut.findAll()
...
const getAllDataById = async (id) => {
  ...
  const deleteIdFromDB = async (id) => {
    ...
    const result = await CashOut.destroy(
      {
        where:{
          id:id
        }
  ...
  const data = {
    ...
    const result = await CashOut.update(data, {
      where: {
        id: id,
      }
    });
